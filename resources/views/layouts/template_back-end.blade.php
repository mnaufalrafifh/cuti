...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('') }}back-end/assets/img/logo.oke.png" rel="icon">
  <link href="{{ asset('') }}back-end/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="{{ asset('') }}back-end/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  ...
  <link href="{{ asset('') }}back-end/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
...
<body>
  ...
  <script src="{{ asset('') }}back-end/assets/vendor/echarts/echarts.min.js"></script>
  <script src="{{ asset('') }}back-end/assets/vendor/quill/quill.min.js"></script>
  <script src="{{ asset('') }}back-end/assets/vendor/simple-datatables/simple-datatables.js"></script>
