...
<script>
  ...
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
          <h3 class="page-header">Tambah Akun</h3>
      </div>
      @if (session('status'))
        ...
        <section class="panel">
          ...
          <div class="card">
            <div class="card-body">
             ...
             <form class="form-validate form-horizontal" method="POST" action="{{ route('tambah-akun.store') }}" enctype="multipart/form-data" autocomplete="off">
            @csrf
             <div class="row">
